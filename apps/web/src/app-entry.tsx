 ...
 * sidebar and editor-dock slots stay placeholders until their
 * verticals. Deactivation runs the one ordered reset — state removal
...
createRoot(mount).render(
  ...
  <ShellProvider client={client} sessionRef={bootstrap.session} role="authoritative">
    <AppShell slots={{ canvas: <CanvasRouteSlot /> }} />
  </ShellProvider>,
);
