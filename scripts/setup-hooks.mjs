 ...
 * for the astroix pre-commit CC scan (wayfinder #55). Idempotent; run once
 * per clone via `bun run hooks`.
 *
...
console.log('astroix: git core.hooksPath -> scripts/hooks (pre-commit CC-warn active)');
