// PROTOTYPE (issue #46) — throwaway, never ships. Steps transcribed from
// docs/manual-smoke.md (the owner's POC definition of done). When this
// prototype is folded in, the step source of truth moves wherever the ticket
// resolution decides.
